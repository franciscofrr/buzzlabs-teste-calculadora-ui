...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17830 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17830(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17834 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17834(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_17837 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_17837(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17838 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17838(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17839 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17839(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17850 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17850(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17817,callback){
var map__17818 = p__17817;
var map__17818__$1 = cljs.core.__destructure_map(map__17818);
var input = map__17818__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17818__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17818__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
