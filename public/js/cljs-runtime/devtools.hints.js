...
var map__12568 = top_item;
var map__12568__$1 = cljs.core.__destructure_map(map__12568);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12568__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12568__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12568__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e12567){var _e = e12567;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___12653 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___12653)){
var seen_errors_12654 = temp__5802__auto___12653;
if(cljs.core.truth_(seen_errors_12654.has(self))){
} else {
seen_errors_12654.add(self);

var temp__5804__auto___12658 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___12658)){
var sense_12665 = temp__5804__auto___12658;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12665)].join(''));
} else {
}
}
} else {
