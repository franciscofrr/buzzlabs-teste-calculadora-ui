...
*/
devtools.toolbox.t_devtools$toolbox15619 = (function (obj,header,style,tag,meta15620){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
this.meta15620 = meta15620;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(devtools.toolbox.t_devtools$toolbox15619.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15621,meta15620__$1){
var self__ = this;
var _15621__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox15619(self__.obj,self__.header,self__.style,self__.tag,meta15620__$1));
}));

(devtools.toolbox.t_devtools$toolbox15619.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15621){
var self__ = this;
var _15621__$1 = this;
return self__.meta15620;
}));

(devtools.toolbox.t_devtools$toolbox15619.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox15619.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox15619.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox15619.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox15619.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta15620","meta15620",-647279339,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox15619.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox15619.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox15619");

(devtools.toolbox.t_devtools$toolbox15619.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"devtools.toolbox/t_devtools$toolbox15619");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox15619.
 */
devtools.toolbox.__GT_t_devtools$toolbox15619 = (function devtools$toolbox$__GT_t_devtools$toolbox15619(obj,header,style,tag,meta15620){
return (new devtools.toolbox.t_devtools$toolbox15619(obj,header,style,tag,meta15620));
});
...
return (new devtools.toolbox.t_devtools$toolbox15619(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
