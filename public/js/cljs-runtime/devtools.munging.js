...
var o12465 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12465["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12466 = temp__5802__auto____$1;
return (o12466["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11553__auto__ = f;
return (o__11553__auto__["toString"]).call(o__11553__auto__);
} else {
return "";
}
}catch (e12473){var _ = e12473;
return "";
}});
...
try{var o__11553__auto___12807 = t;
(o__11553__auto___12807["cljs$lang$ctorPrWriter"]).call(o__11553__auto___12807,t,writer);
}catch (e12485){var __12808 = e12485;
}
...
var char_code = (function (){var o__11553__auto__ = (new String(char$));
return (o__11553__auto__["charCodeAt"]).call(o__11553__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11553__auto__ = String;
return (o__11553__auto__["fromCharCode"]).call(o__11553__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12535 = num_code;
switch (G__12535) {
case (1):
return (185);
...
var o__11553__auto__ = String;
return (o__11553__auto__["fromCharCode"]).call(o__11553__auto__,superscript_code);
});
/**
...
}catch (e12549){var _e__11582__auto__ = e12549;
return false;
}})())){
...
var vec__12555 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12555,(0),null);
...
var len__5726__auto___12824 = arguments.length;
var i__5727__auto___12825 = (0);
while(true){
if((i__5727__auto___12825 < len__5726__auto___12824)){
args__5732__auto__.push((arguments[i__5727__auto___12825]));

var G__12826 = (i__5727__auto___12825 + (1));
i__5727__auto___12825 = G__12826;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12576){
var vec__12577 = p__12576;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12577,(0),null);
...
var G__12828 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12829 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12828;
remaining_tokens = G__12829;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12570){
var G__12571 = cljs.core.first(seq12570);
var seq12570__$1 = cljs.core.next(seq12570);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12571,seq12570__$1);
}));
...
var vec__12596 = cljs.core.split_with((function (p1__12595_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12595_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12596,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12596,(1),null);
...
var vec__12612 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12612,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12612,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12831 = cljs.core.rest(remaining_tokens);
var G__12832 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12831;
name_tokens = G__12832;
continue;
} else {
...
var vec__12631 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12631,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12631,(1),null);
var vec__12634 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(1),null);
var vec__12637 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12637,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12637,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12637,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12637,(3),null);
...
var vec__12646 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12655 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12655,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12655,(1),null);
var vec__12662 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12662,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12662,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12670 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12670) : devtools.munging.parse_fn_info_deep.call(null,G__12670));
})()));
}
} else {
return fn_info;
...
var G__12843 = (arity + (1));
var G__12844 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12693){
var vec__12694 = p__12693;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12694,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12694,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12706_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12706_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12707_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12707_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12722){
var vec__12723 = p__12722;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12723,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12718){
var G__12719 = cljs.core.first(seq12718);
var seq12718__$1 = cljs.core.next(seq12718);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12719,seq12718__$1);
}));
...
var map__12741 = options;
var map__12741__$1 = cljs.core.__destructure_map(map__12741);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12741__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12741__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12741__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12741__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12742 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12742,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12742,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12742,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12742,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12742,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12742,(5),null);
...
var o__11553__auto__ = f;
return (o__11553__auto__["getBasis"]).call(o__11553__auto__);
});
/**
...
}catch (e12755){var _e__11582__auto__ = e12755;
...
var G__12872 = (obj[cljs.core.first(path)]);
var G__12873 = cljs.core.rest(path);
obj = G__12872;
path = G__12873;
continue;
} else {
...
var _STAR_ = (function (accum,p__12767){
var vec__12768 = p__12767;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12768,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12768,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12778){
var vec__12780 = p__12778;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12780,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12780,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12780,(2),null);
...
var post_process = (function (p__12790){
var vec__12791 = p__12790;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12791,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12791,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12785_SHARP_){
return (obj[cljs.core.first(p1__12785_SHARP_)]);
}),sorted_matches);
