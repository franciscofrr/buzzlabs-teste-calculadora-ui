...
var i_17915 = (0);
while(true){
if((i_17915 < arr.length)){
(arr[i_17915] = null);

var G__17916 = (i_17915 + (1));
i_17915 = G__17916;
continue;
} else {
}
...
var i_17930 = (self__.level + (1));
while(true){
if((i_17930 <= (new_level + (1)))){
(update[i_17930] = self__.header);

var G__17931 = (i_17930 + (1));
i_17930 = G__17931;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17932 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17932[i]));
} else {
x__$2.forward.push((((i < links_17932.length))?(links_17932[i]):null));
}

if((i < links_17932.length)){
(links_17932[i] = x__$2);
} else {
links_17932.push(x__$2);
}
...
var i_17944 = (0);
while(true){
if((i_17944 <= self__.level)){
var links_17945 = (update[i_17944]).forward;
if((x__$1 === (((i_17944 < links_17945.length))?(links_17945[i_17944]):null))){
(links_17945[i_17944] = (x__$1.forward[i_17944]));

var G__17946 = (i_17944 + (1));
i_17944 = G__17946;
continue;
} else {
var G__17947 = (i_17944 + (1));
i_17944 = G__17947;
continue;
}
} else {
...
var G__17949 = nx;
var G__17950 = (level__$1 - (1));
x = G__17949;
level__$1 = G__17950;
continue;
} else {
var G__17951 = x;
var G__17952 = (level__$1 - (1));
x = G__17951;
level__$1 = G__17952;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__17957 = nx;
var G__17958 = (level__$1 - (1));
x = G__17957;
level__$1 = G__17958;
continue;
} else {
var G__17959 = x;
var G__17960 = (level__$1 - (1));
x = G__17959;
level__$1 = G__17960;
continue;
}
