...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22507 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22507(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22509 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22509(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22510 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22510(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22515 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22515(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22516 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22516(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22518 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22518(reader);
}
});
...
var G__22584 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22585 = s.append(c);
c = G__22584;
s = G__22585;
continue;
}
