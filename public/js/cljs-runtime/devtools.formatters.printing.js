...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12866){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12867,G__12868,seq12866__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12887_SHARP_){
return (!((cljs.core.meta(p1__12887_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12901__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12902){var _e__11582__auto__ = e12902;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e12908){var _e__11582__auto__ = e12908;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12917 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12918 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12918);
...
var map__12919 = opts;
var map__12919__$1 = cljs.core.__destructure_map(map__12919);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12919__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12917);
}});
...
var temp__5802__auto___12975 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12975)){
var managed_print_level_12976 = temp__5802__auto___12975;
var _STAR_print_level_STAR__orig_val__12922_12977 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12923_12978 = managed_print_level_12976;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12923_12978);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12921_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12921_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12922_12977);
}} else {
job_fn();
}
