...
var G__23097 = o;
reagent.impl.template.goog$module$goog$object.set(G__23097,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23396__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23396 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23397__i = 0, G__23397__a = new Array(arguments.length -  0);
while (G__23397__i < G__23397__a.length) {G__23397__a[G__23397__i] = arguments[G__23397__i + 0]; ++G__23397__i;}
  args = new cljs.core.IndexedSeq(G__23397__a,0,null);
} 
return G__23396__delegate.call(this,args);};
G__23396.cljs$lang$maxFixedArity = 0;
G__23396.cljs$lang$applyTo = (function (arglist__23399){
var args = cljs.core.seq(arglist__23399);
return G__23396__delegate(args);
});
...
var G__23227 = o;
reagent.impl.template.goog$module$goog$object.set(G__23227,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23405__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__23406__i < G__23406__a.length) {G__23406__a[G__23406__i] = arguments[G__23406__i + 0]; ++G__23406__i;}
  args = new cljs.core.IndexedSeq(G__23406__a,0,null);
} 
return G__23405__delegate.call(this,args);};
G__23405.cljs$lang$maxFixedArity = 0;
G__23405.cljs$lang$applyTo = (function (arglist__23407){
var args = cljs.core.seq(arglist__23407);
return G__23405__delegate(args);
});
...
var G__23334 = props;
var G__23334__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23334,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23334);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23334__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23336 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23336,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23336;
}
})(),id_class);
...
var temp__5804__auto___23413 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___23413)){
var d_23414 = temp__5804__auto___23413;
if((d_23414 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_23414.s}));
} else {
...
var G__23338 = (cljs.core.count(argv) - first_child);
switch (G__23338) {
case (0):
...
var vec__23347 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23347,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23347,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23347,(2),null);
...
var temp__5808__auto___23418 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23418 == null)){
} else {
var key_23423 = temp__5808__auto___23418;
(jsprops.key = key_23423);
}
...
var temp__5808__auto___23425 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23425 == null)){
} else {
var key_23426 = temp__5808__auto___23425;
(jsprops.key = key_23426);
}
...
var temp__5808__auto___23429 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23429 == null)){
} else {
var key_23431 = temp__5808__auto___23429;
(jsprops.key = key_23431);
}
...
var temp__5808__auto___23432 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23432 == null)){
} else {
var key_23433 = temp__5808__auto___23432;
(jsprops.key = key_23433);
}
...
var temp__5808__auto___23447 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23447 == null)){
} else {
var key_23449 = temp__5808__auto___23447;
(jsprops.key = key_23449);
}
...
var temp__5808__auto___23452 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23452 == null)){
} else {
var key_23453 = temp__5808__auto___23452;
(jsprops.key = key_23453);
}
...
var ctx = ({});
var vec__23378 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23378,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23378,(1),null);
...
break;
default:
var G__23460 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23461 = compiler;
v = G__23460;
compiler = G__23461;
continue;
...
var G__23382 = tag;
var G__23382__$1 = (((G__23382 instanceof cljs.core.Keyword))?G__23382.fqn:null);
switch (G__23382__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template23386 = (function (opts,id,fn_to_element,parse_fn,meta23387){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23386.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23388,meta23387__$1){
var self__ = this;
var _23388__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23386(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23387__$1));
}));

(reagent.impl.template.t_reagent$impl$template23386.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23388){
var self__ = this;
var _23388__$1 = this;
return self__.meta23387;
}));

(reagent.impl.template.t_reagent$impl$template23386.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23386.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23386.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23386.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23386.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23386.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23387","meta23387",-783600596,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23386.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23386.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23386");

(reagent.impl.template.t_reagent$impl$template23386.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template23386");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23386.
 */
reagent.impl.template.__GT_t_reagent$impl$template23386 = (function reagent$impl$template$__GT_t_reagent$impl$template23386(opts,id,fn_to_element,parse_fn,meta23387){
return (new reagent.impl.template.t_reagent$impl$template23386(opts,id,fn_to_element,parse_fn,meta23387));
});
...
return (new reagent.impl.template.t_reagent$impl$template23386(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
