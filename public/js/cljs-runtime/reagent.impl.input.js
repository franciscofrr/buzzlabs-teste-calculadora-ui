...
while(true){
var temp__5802__auto__ = active_element.shadowRoot;
if(cljs.core.truth_(temp__5802__auto__)){
var shadow_root = temp__5802__auto__;
var G__22993 = shadow_root.activeElement;
active_element = G__22993;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__22938){
var map__22939 = p__22938;
var map__22939__$1 = cljs.core.__destructure_map(map__22939);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22939__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__5002__auto__ = (!((((node === reagent.impl.input.get_true_active_element())) && (((reagent.impl.input.has_selection_api_QMARK_(node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__5002__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__22949 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__22950 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__22950);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__22949);
}}));
} else {
...
(jsprops.onChange = (function (p1__22956_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__22956_SHARP_);
}));
